        ...
        <div className="w-full bg-gray-900 ">
          <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div className="flex flex-wrap py-10 -mx-3">
              <div className="w-full px-4 mb-11 md:w-1/2 lg:w-[20%] lg:mb-0">
                <a
                  href="#"
                ...
                <div className="flex justify-start mt-4 ">
                  ...
                  <a
                    ...
                    type="button"
                    className="m-1 leading-normal text-gray-300 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full    hover:border-[#8A41AA] text-text-gray-50 hover:bg-[#8A41AA] w-9 h-9"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      className="w-5 h-full mx-auto text-gray-300  bi bi-linkedin"
                    >
                      <path
                        fill="currentColor"
                  ...
                  <a
                    ...
                    type="button"
                    className="m-1 leading-normal text-gray-300 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full  hover:border-[#CD201F] hover:bg-[#CD201F] w-9 h-9"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                  ...
                  <a
                    ...
                    type="button"
                    className="m-1 leading-normal text-gray-400 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full    hover:border-[#24CC63] hover:bg-[#24CC63] w-9 h-9"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      className="w-[22px] h-full mx-auto text-gray-300  bi bi-linkedin"
                    >
                      <g fill="none" fillRule="evenodd">
                        <path d="M24 0v24H0V0h24ZM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018Zm.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022Zm-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01l-.184-.092Z" />
                        <path
              ...
              <div className="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0">
                <h2 className="mb-4 text-xl font-bold text-gray-200 ">Links</h2>
                <ul>
                  <li className="flex items-center mb-4 ">
                    ...
                    <Link
                      to="/about"
                      className="inline-block text-base font-normal text-gray-300  hover:scale-105 hover:translate-x-2 duration-500"
                    >
                      About Us
                    </Link>
                  </li>
              ...
              <div className="w-full px-4 md:w-1/4 lg:w-[25%] mb-11 lg:mb-0">
              ...
              <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-[25%]">
                ...
                <p className="flex items-center">
                  ...
                  <a
                    href="mailto:info@muslin.com.bd"
                    className="hover:scale-105 hover:translate-x-2 duration-500 py-1"
                  >
                    <span className="text-gray-300 ">info@muslin.com.bd</span>
                  </a>
                </p>
                <p className="flex items-center">
                  <svg
                  ...
                  >
                    <span className="text-gray-300 ">01580799986</span>
                  </a>
                </p>
              </div>
            </div>
          ...
          <div className="py-5 text-center text-gray-200 bg-gray-700  text-sm">
